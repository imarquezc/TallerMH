...
class ComprasControllerTest < ActionController::TestCase
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post :create, compra: { cantidad: @compra.cantidad, p_compra: @compra.p_compra, p_venta: @compra.p_venta, producto: @compra.producto }
    end
  ...
  test "should update compra" do
    patch :update, id: @compra, compra: { cantidad: @compra.cantidad, p_compra: @compra.p_compra, p_venta: @compra.p_venta, producto: @compra.producto }
    assert_redirected_to compra_path(assigns(:compra))
  end
